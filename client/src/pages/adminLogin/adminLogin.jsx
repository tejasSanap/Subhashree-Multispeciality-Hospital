                ...
                <div className={`con ${classAdd}`} id="container">
                    <div className="form-container sign-up-container">
                        <form onSubmit={handleSubmit(onSubmit)} className="login-form">
                            ...
                            <button style={{borderRadius: "4px"}} type='submit' id="signIn">Sign In</button>
                        </form>
                    </div>
                    ...
                    <div className="form-container sign-in-container">
                        <div className="login-form">
                            <form onSubmit={handleSubmit(onSubmit)} className="login-form">
                                    <h2>Admin</h2>
                                    <input type="email" placeholder='Email' className='pt-2 d-inline-block' {...register("email", { required: true, pattern: /^\S+@\S+$/i })} />
                                    <input type="password" placeholder='Password' className='pt-2 d-inline-block'  {...register("password", { required: true })} />
                                    <button type='submit' className="ghost" id="signIn">ACCEPT</button>
                    ...
                    <div className="overlay-container">
                            <div className="overlay">
                                <div className="overlay-panel overlay-left">
                                    ...
                                    <button onClick={() => handleSubmit()} className="ghost" id="signIn">Sign In</button>
                                </div>
