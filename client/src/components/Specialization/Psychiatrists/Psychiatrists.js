      ...
      <div className="specialization_container">
        <div className="specialization_banner">
          ...
          <div className="specialization_navigation">
            <Link to="/">Home </Link>
            <span>&#62;</span>
            <Link to="/specialization/psychiatrists"> Psychiatrists</Link>
          </div>
        </div>
          ...
          <div className=" inner_specialization">
            <div className="specialization_left ">
              <div className="special_img">
                <img src="https://i.ibb.co/2WgQbXV/blog-13.jpg" alt="" />
              </div>
              <div className="department">
                <h5>DEPARTMENT</h5>
                <h2>
                  <span>Psychiatrists</span> Association
                </h2>
                <p>
                  A psychiatrists is a doctor that deals with the cardiovascular
