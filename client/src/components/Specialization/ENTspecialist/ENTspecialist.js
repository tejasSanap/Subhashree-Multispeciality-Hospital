      ...
      <div className="specialization_container">
        <div className="specialization_banner">
          ...
          <div className="specialization_navigation">
            <Link to="/">Home </Link>
            <span>&#62;</span>
            <Link to="/specialization/ent-specialist"> ENT specialist</Link>
          </div>
        </div>
          ...
          <div className=" inner_specialization">
            <div className="specialization_left ">
              <div className="special_img">
                <img src="https://i.ibb.co/NmRRhZ7/blog-9.jpg" alt="" />
              </div>
              <div className="department">
                <h5>DEPARTMENT</h5>
                <h2>
                  <span>ENT </span> Specialist
                </h2>
                <p>
                  A ENT specialist is a doctor that deals with the
                  cardiovascular system. This means he or she treats any
                  abnormality in our blood vessels and heart. This can include
                  heart disease or condition which requires diagnosis and
                  treatment.
                </p>
              </div>
